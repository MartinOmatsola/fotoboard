...
print '<html>
	<head><title>F O T O B O A R D  A L B U M S</title>
	</head>
	<body>
	<center>
		...
		<tr><td align="center" style="font-family:Tahoma;color:#FFFFFF;font-size:16px;background:#1A1A63" colspan="2"><b>Album IDs</b></td></tr>';
foreach ($albums as $num => $id) {
	$id = basename($id);
	if ($id != "index.php") {
		$num++;
